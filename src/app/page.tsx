...
function MemoryCanvas() {
  ...
  useEffect(() => {
    ...
    const orbColors = [0xc9c2e0, 0xc5d9c3, 0xf2d5d5, 0xe8cfc0, 0xd5c9f0];
    ...
    const lineMat = new THREE.LineBasicMaterial({ color: 0xb8aee0, transparent: true, opacity: 0.08 });
    ...
    scene.add(dirLight);
    const ptLight = new THREE.PointLight(0xc9c2e0, 1.5, 20);
...
function TypedText({ phrases }: { phrases: string[] }) {
  ...
  return (
    <span style={{ color: "var(--lavender)", fontStyle: "italic" }}>
      {text}
...
export default function LandingPage() {
  ...
  const testimonials = [
    { text: "My mother asked to hear about her wedding day. LifeLens found the audio clip she recorded last year and played it back. She smiled the whole time.", name: "Priya S.", role: "Family member, Mumbai", initial: "P", color: "var(--lavender)" },
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-gem {
          ...
          background: linear-gradient(135deg, var(--lavender) 0%, #7A9E7A 100%);
        ...
        .nav-links a.nav-cta:hover { background: var(--lavender); transform: translateY(-1px); }
        ...
        .hero-badge {
          ...
          color: var(--lavender); letter-spacing: 0.1em;
          text-transform: uppercase; margin-bottom: 36px;
          animation: fadeUp 0.8s ease both;
        }
        .pulse { width: 6px; height: 6px; border-radius: 50%; background: var(--lavender); animation: pulse 2s infinite; }
        ...
        .btn-primary {
          background: linear-gradient(135deg, var(--lavender), #7A6BB0);
          color: white; padding: 15px 36px;
          border-radius: 100px; font-size: 15px; font-weight: 500;
          text-decoration: none; border: none; cursor: pointer;
          box-shadow: 0 6px 28px rgba(155,142,196,0.4);
          transition: transform 0.25s, box-shadow 0.25s;
          letter-spacing: 0.02em;
        }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 36px rgba(155,142,196,0.5); }
        .btn-ghost {
        ...
        .mood-bar {
          ...
          background: rgba(155,142,196,0.15); margin-top: 14px; overflow: hidden;
        }
        .mood-fill {
          height: 100%; border-radius: 100px;
          background: linear-gradient(90deg, var(--lavender), var(--sage-light));
        }
        ...
        .trust-num {
          font-family: 'Cormorant Garamond', serif;
          font-size: 36px; font-weight: 400; color: var(--lavender);
          line-height: 1;
        }
        ...
        .section-h em { font-style: italic; color: var(--lavender); }
        .section-sub {
        ...
        .roles-bg {
          position: relative; z-index: 1;
          background: linear-gradient(160deg, var(--lavender-pale) 0%, var(--cream) 55%, var(--sage-pale) 100%);
          padding: 110px 60px;
        }
        .role-tabs {
        ...
        .steps-wrap::before {
          ...
          background: linear-gradient(90deg,transparent,var(--lavender-light),var(--sage-light),transparent);
        }
        .step { display: flex; flex-direction: column; align-items: center; text-align: center; padding: 0 16px; }
        .step-circle {
          width: 80px; height: 80px; border-radius: 50%;
          background: white; border: 1.5px solid var(--lavender-light);
          display: flex; align-items: center; justify-content: center;
          font-family: 'Cormorant Garamond', serif;
          font-size: 26px; font-weight: 400; color: var(--lavender);
          margin-bottom: 22px; position: relative; z-index: 1;
          box-shadow: 0 4px 20px rgba(155,142,196,0.18);
          transition: transform 0.3s, box-shadow 0.3s;
        }
        .step:hover .step-circle { transform: scale(1.08); box-shadow: 0 8px 32px rgba(155,142,196,0.3); }
        ...
        .cta-h em { font-style: italic; color: var(--lavender); }
        .cta-p {
        ...
        .btn-outline:hover { border-color: var(--lavender); transform: translateY(-1px); }
      ...
      <section className="hero">
        ...
        <div className="hero-cards">
          <MemCard icon="🌸" type="Image Memory" title="Garden walk with Anna" meta="Yesterday · Mumbai · 😊 Happy" accentColor="#9B8EC4" barWidth={82} />
          <div className="mem-card">
            ...
            <div className="avatar-row">
              {[["R", "#9B8EC4"], ["A", "#7A9E7A"], ["M", "#D4A0A0"]].map(([l, c]) => (
      ...
      <section className="section" id="features">
        <div className="reveal" data-delay="0">
          <div className="section-tag tag-lavender">Core features</div>
        ...
        <div className="features-grid">
          {[
            { icon: "🧠", title: "Semantic memory search", desc: "Ask in plain words — 'What did I do last Christmas?' — and LifeLens finds the answer from stored photos, voice notes, and text, grounded in real evidence.", accent: "#9B8EC4" },
            ...
            { icon: "👥", title: "Family portal", desc: "A safe, read-only window for loved ones. Browse the memory lane, request a new memory capture, or leave a message — with dignity and privacy.", accent: "#9B8EC4" },
      ...
      <section className="roles-bg" id="roles">
        <div className="reveal" data-delay="0">
          <div className="section-tag tag-lavender">Who it&apos;s for</div>
      ...
      <section className="section" style={{ background: "var(--cream)" }}>
        <div className="reveal" data-delay="0" style={{ textAlign: "center" }}>
          <div className="section-tag tag-lavender" style={{ display: "inline-block" }}>Stories of care</div>
      ...
      <section className="cta-wrap">
        <div className="reveal" data-delay="0">
          <div className="section-tag tag-lavender" style={{ display: "inline-block", marginBottom: 28 }}>Begin today</div>
