...
const filterChips = ['All', 'Patients', 'Memories', 'Medications', 'Alerts'];
  ...
  return (
    <header className="sticky top-0 z-30 px-4 md:px-6 py-3">
      <div className="flex items-center justify-between gap-2 md:gap-4">
        {/* Mobile Menu Button */}
        <button onClick={toggleSidebar} className="md:hidden p-2 -ml-2 rounded-xl text-[#5A576E] hover:bg-[#F0EDF8] transition-colors flex-shrink-0">
        ...
        <div className="flex-1 max-w-2xl min-w-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#f6f5fa] border-none shadow-[inset_0px_3px_6px_rgba(30,27,46,0.05),inset_0px_-1px_2px_rgba(255,255,255,1)] focus:ring-2 focus:ring-[#9B8EC4]/30 rounded-[14px] pl-10 pr-4 py-2.5 outline-none text-sm transition-all text-[#1E1B2E] font-medium placeholder:text-[#9896B0]"
            />
            {searchQuery && (
              <button
              ...
              <button
                ...
                className={cn(
                  ...
                  activeChip === chip
                    ...
                    : 'bg-[#F0EDF8] text-[#5A576E] hover:bg-[#C9C2E0]/30'
                )}
              >
                {chip}
              </button>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2.5 rounded-xl hover:bg-[#F0EDF8] transition-colors"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 top-12 w-80 card p-4 shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex gap-3 p-2 rounded-lg hover:bg-[#F0EDF8]">
          ...
          {/* User menu */}
          <button className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-[#F0EDF8] transition-colors">
            <div 
