...
export const demoCredentials = [
  { username: 'alice', password: 'password', role: 'patient' as const, label: 'Patient (Alice)' },
  { username: 'bob', password: 'password', role: 'caretaker' as const, label: 'Caretaker (Dr. Bob)' },
  { username: 'carol', password: 'password', role: 'family' as const, label: 'Family (Carol)' },
];
