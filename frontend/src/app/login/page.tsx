...
const roleCards = [
  { role: 'patient' as const, icon: User, label: 'Patient', color: '#FF8C42', bg: '#FFF5E6' },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-[#FFF5E6] rounded-full blur-[120px] opacity-60 pointer-events-none" />
        ...
        >
          ...
          >
            ...
            {/* Subtle Tab Switcher */}
            <div className="flex bg-[#F6F5FA] p-1 rounded-[16px] shadow-[inset_0px_2px_4px_rgba(30,27,46,0.03)] border border-[#FFC299]/20 mb-5">
              <button 
                onClick={() => setTab('login')} 
                className={cn('flex-1 py-1.5 rounded-[12px] text-[13px] font-medium transition-all duration-300', tab === 'login' ? 'bg-white shadow-[0_2px_8px_rgba(255, 140, 66,0.15)] text-[#1E1B2E]' : 'text-[#9896B0] hover:text-[#5A576E]')}
              >
                Login
              </button>
              <button 
                onClick={() => setTab('register')} 
                className={cn('flex-1 py-1.5 rounded-[12px] text-[13px] font-medium transition-all duration-300', tab === 'register' ? 'bg-white shadow-[0_2px_8px_rgba(255, 140, 66,0.15)] text-[#1E1B2E]' : 'text-[#9896B0] hover:text-[#5A576E]')}
              >
                Register
              </button>
            </div>
                ...
                <motion.div key="login" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }}>
                  <div className="space-y-3.5">
                    <div>
                      ...
                      <input 
                        className="w-full bg-[#f6f5fa] border-none shadow-[inset_0px_3px_6px_rgba(30,27,46,0.05),inset_0px_-1px_2px_rgba(255,255,255,1)] focus:ring-2 focus:ring-[#FF8C42]/30 rounded-[14px] px-4 py-2.5 outline-none text-[14px] transition-all text-[#1E1B2E]"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input 
                          className="w-full bg-[#f6f5fa] border-none shadow-[inset_0px_3px_6px_rgba(30,27,46,0.05),inset_0px_-1px_2px_rgba(255,255,255,1)] focus:ring-2 focus:ring-[#FF8C42]/30 rounded-[14px] pl-4 pr-10 py-2.5 outline-none text-[14px] transition-all text-[#1E1B2E]"
                    ...
                    <button 
                      ...
                      className="w-full text-white rounded-full flex items-center justify-center gap-2 py-3 mt-5 hover:-translate-y-[1px] shadow-[0_6px_20px_rgba(255, 140, 66,0.3)] transition-all font-medium text-[14px]"
                    >
                  ...
                  {/* Demo credentials */}
                  <div className="mt-5 p-4 rounded-[18px] bg-[#FFF5E6]/60 border border-[#FFC299]/40">
                    <div className="flex items-center gap-2 mb-2">
                      <Info className="w-[14px] h-[14px] text-[#FF8C42]" />
                      <span className="text-[10px] font-semibold text-[#FF8C42] uppercase tracking-widest">Demo Access</span>
                    </div>
                    <div className="space-y-1.5 flex flex-col">
                      {demoCredentials.map((c) => (
                        <button 
                          ...
                          className="w-full flex items-center justify-between text-[12px] py-1.5 px-3 rounded-[10px] hover:bg-white border border-transparent hover:border-[#FFC299]/40 transition-all text-[#5A576E]"
                        >
          ...
          <div className="flex items-center justify-center gap-5 mt-5">
            ...
            <button className="text-[11px] text-[#9896B0] hover:text-[#FF8C42] transition-colors">
              Privacy & Security
            </button>
          </div>
        </motion.div>
